...
{
    CGFloat padding = type == EaseInputTipsViewTypeLogin? kPaddingLeftWidth: 0;
    self = [super initWithFrame:CGRectMake(padding, 0, SCREEN_WIDTH - 2 * padding, 120)];
    if (self) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(kLoginPaddingLeftWidth, 0, SCREEN_WIDTH - 2 * kLoginPaddingLeftWidth, 35)];
