...
+ (void)showIntroPage{
    ...
    EAIntroView *introView = [[EAIntroView alloc] initWithFrame:[UIScreen mainScreen].bounds andPages:pages];
...
+ (UIButton *)p_skipButton{
    UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH*0.7, 60)];
