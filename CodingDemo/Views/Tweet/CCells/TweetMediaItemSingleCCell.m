...
#define kTweetMediaItemCCellSingle_Width (0.6 *SCREEN_WIDTH)
#define kTweetMediaItemCCellSingle_WidthMonkey ((SCREEN_WIDTH - 36.0)/3.0)
#define kTweetMediaItemCCellSingle_MaxHeight (0.5 *SCREEN_WIDTH)
