...
#define kTweetCommentCell_ContentWidth (SCREEN_WIDTH -kPaddingLeftWidth - kPaddingLeftWidth - 2*kTweetCommentCell_LeftOrRightPading)
...
+ (CGFloat)cellHeightWithObj:(id)obj
{
    ...
    if ([obj isKindOfClass:[Comment class]]) {
        ...
        height = MIN(kTweetCommentCell_ContentMaxHeight, [curComment.content getHeightWithFont:kTweet_CommentFont constrainedToSize:CGSizeMake(kTweetCommentCell_ContentWidth, CGFLOAT_MAX)] + 15 + kScaleFrom_iPhone5_Desgin(15));//取两者较小值
    }
    return ceilf(height);
}
