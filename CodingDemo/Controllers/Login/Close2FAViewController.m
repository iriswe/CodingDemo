...
#pragma mark Haeder Footer
- (UIView *)customFooterView{
    UIView *footerV = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 150)];
    _footerBtn = [UIButton buttonWithStyle:StrapSuccessStyle andTitle:@"关闭两步验证" andFrame:CGRectMake(kLoginPaddingLeftWidth, 20, SCREEN_WIDTH - kLoginPaddingLeftWidth*2, 45) target:self action:@selector(footerBtnClicked:)];
