...
- (UIView *)customFooterView{
    ...
    _footerBtn = [UIButton buttonWithStyle:StrapSuccessStyle andTitle:[self footerBtnTitle] andFrame:CGRectMake(kLoginPaddingLeftWidth, 20, SCREEN_WIDTH - kLoginPaddingLeftWidth * 2, 45) target:self action:@selector(footerBtnClicked:)];
